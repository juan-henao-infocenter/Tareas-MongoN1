...
document.write(totalMaticulas, '<h1>Telefonos</h1>', telefonos, '<h1>Estudiante matricula mas grande</h1>', `<h2>${estudianteMatriculaMax.nombre} ${estudianteMatriculaMax.detalles.contacto.email}</h2>`);
